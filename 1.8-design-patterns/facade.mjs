...
class MagicSquareGenerator {
  generate(size) {
    ...
    let magicSquare = new Array(size).fill();
    let arrangements;
    do {
      magicSquare = magicSquare.map(() => generator.generate(size));
      arrangements = splitter.split(magicSquare);
    } while (!verifier.verify(arrangements));
