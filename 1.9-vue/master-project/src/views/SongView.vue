...
import { auth, songsCollection, commentsCollection } from '../includes/fake-server'
...
export default {
  ...
  computed: {
    ...
    sortedComments() {
      if (this.sort === '1') {
        return this.comments.slice().sort((a, b) => new Date(a.datePosted) - new Date(b.datePosted))
      }

      return this.comments.slice().sort((a, b) => new Date(b.datePosted) - new Date(a.datePosted))
    }
  },
  methods: {
    ...
    <section class="container mx-auto mt-6" id="comments">
      <div class="bg-white rounded border border-gray-200 relative flex flex-col">
        ...
        <div class="p-6">
          ...
          <VeeForm v-if="userIsLoggedIn" :validation-schema="schema" @submit="addComment">
            <VeeField
              as="textarea"
              name="comment"
